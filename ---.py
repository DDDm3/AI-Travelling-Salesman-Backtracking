...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # self.comboBox_2.setGeometry(QtCore.QRect(1300, 240, 150, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "THUẬT TOÁN"))
    ...
    def find_path(self):
        ...
        problem = CSPproblem(variables, domains, graph,start)
        ...
        if algorithm == 'ac3':
            ...
            solver = Backtracking_mrv(variables, domains, graph, start, algorithm)      
            start_time = time.time()
            path, cost = solver.solve(start)
            end_time = time.time()
            print(f"Execution Time: {end_time - start_time:.2f} seconds")
